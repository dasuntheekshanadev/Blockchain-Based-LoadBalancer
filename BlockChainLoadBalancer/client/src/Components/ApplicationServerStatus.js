...
const ApplicationServerStatus = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold text-center mb-8">Application Server 1 Status</h1>
      <div className="flex justify-center">
        <div className="bg-gradient-to-b from-gray-700 to-black rounded-lg shadow-md p-6 w-full max-w-md">
...
export default ApplicationServerStatus;
